...
% tabularx has to scan its whole body, so it cannot be split across this environment's
% begin and end. A p-column gives the same wrapping without that restriction.
\newenvironment{configtable}[1]{%
    \begin{table}[H]
    \centering
    \caption{#1}
