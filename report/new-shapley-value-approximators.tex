...
\documentclass[%
    ...
    parskip=half-,          % a report is denser than a thesis: half a line between
                            % paragraphs, and no stretch
    11pt,
    headings=normal,
    bibliography=totoc,
    listof=totoc,
...
\input{content/02-benchmark}
%\input{content/03-oddshap}
%\input{content/04-leverageshap}
%\input{content/05-polyshap}
